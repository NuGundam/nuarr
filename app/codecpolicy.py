    ...
    "audio": [
        ...
        {"key": "tag_untagged_audio",
         ...
         "what": "A track with no language tag is not neutral — Sonarr and "
                 ...
                 "page are working from a false premise. nuarr LISTENS to the "
                 "track — three 30-second windows from the middle of the file, "
                 "run through Whisper's language identifier, which all have to "
                 "agree — and writes what it actually hears. Where it has not "
                 "listened yet it falls back to inference: one audio track, no "
